    ...
    <div class="desc_board">
      ...
      <div class="info">
      	<c:forEach var="file" items="${data.fileList}">
           	<button type="button" class="btn_down-file" onclick ="downloadFile('${file.originFileName}','${file.renameFileName }','${file.savePath}')">${file.originFileName}</button><br>
      	</c:forEach> 
...
<script type="text/javascript">
   ...
   function downloadFile(ofname,rfname,savePath){
      ...
      location.href = '${context}' + "/board/download.do?" + urlEncodeForm(params);
   }
